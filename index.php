                ...
                <div class="resume_container">
                    <div class="col-md-6 col-sm-6 left">
                        ...
                        <div class="resume_item">
                            ...
                            <div class="resume_description"><a href="<?php echo get_post_meta($post->ID, 'work_url', true); ?>" target="_blank"><strong><?php echo get_post_meta($post->ID, 'resume_place', true); ?></strong></a><strong><?php the_title(); ?></strong></div>
                            <?php the_content(); ?>
                        </div>
                            <? endwhile; endif; wp_reset_query(); ?>
                    </div>
            ...
            <div class="row">
                <div class="filter_div controls">
                    <ul>
                        ...
                        <li class="filter" data-filter=".landing">Лендинги</li>
                        <li class="filter" data-filter=".internet-shop">Интернет-магазины</li>
                        <li class="filter" data-filter=".corp-site">Корпоративные сайты</li>
                    </ul>
                </div>
                        ...
                        <div class="hidden">
                            <div class="podrt_descr">
                                <div class="modal-box-content">
                                    ...
                                    <h3><?php the_title(); ?></h3>
                                    <?php the_content(); ?>
                                    <a href="<?php echo get_post_meta($post->ID, 'work_url', true); ?>" target="_blank">Перейти на сайт</a>
                                    <img src="<?php
                                    $large_image_url = wp_get_attachment_image_src( get_post_thumbnail_id(), 'large' );
                                    echo $large_image_url[0];
                                    ?>" alt="<?php the_title(); ?>" />
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    ...
                    <div class="contact_box">
                        ...
                        <p><a href="tel:<?php
                            $options = get_option('sample_theme_options');
                            echo $options['phonetext']; ?>"><?php
                                $options = get_option('sample_theme_options');
                                echo $options['phonetext']; ?></a></p>
                    </div>
                    <div class="contact_box">
                        <div class="contacts_icon icon-basic-mail-multiple"></div>
                        <h3>Email:</h3>
                        <p><a href="mailto:<?php
                            $options = get_option('sample_theme_options');
                            echo $options['emailtext']; ?>" target="_blank"><?php
                                $options = get_option('sample_theme_options');
                                echo $options['emailtext']; ?></a></p>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
                    <form action="http://formspree.io/grigoliya.g@gmail.com" class="main_form" novalidate target="_blank" method="post">
