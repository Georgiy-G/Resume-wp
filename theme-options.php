			...
			<table class="form-table">
				...
				<tr valign="top"><th scope="row"><?php _e( 'Телефон', 'sampletheme' ); ?></th>
					<td>
						...
						<label class="description" for="sample_theme_options[sometext]"></label>
					</td>
				</tr>
				<tr valign="top"><th scope="row"><?php _e( 'Почта', 'sampletheme' ); ?></th>
					<td>
				 ...
				 */
				?>
				<tr valign="top"><th scope="row"><?php _e( 'Выберите цвет', 'sampletheme' ); ?></th>
					<td>
